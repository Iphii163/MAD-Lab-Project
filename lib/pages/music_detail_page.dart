...
class _MusicDetailPageState extends State<MusicDetailPage> {
  ...
  late AudioPlayer advancedPlayer; // Use 'late' and only AudioPlayer
  bool isPlaying = true;
  ...
  Future<void> stopSound(String localPath) async {
    await advancedPlayer.stop();
  }

  Future<void> seekSound() async {
    await advancedPlayer.seek(Duration(milliseconds: 2000));
  }
